...
/**
 * Created by Yash Agarwal on 24-06-2018.
 */
...
public class SharedPreferenceUtils {
    ...
    public SharedPreferenceUtils(Context context,String ty) {
        mContext = context;
        mSharedPreferences = context.getSharedPreferences(ty, Context.MODE_PRIVATE);
     ...
     */
    public static synchronized SharedPreferenceUtils getInstance(Context context,String ty) {

        if (mSharedPreferenceUtils == null) {
            mSharedPreferenceUtils = new SharedPreferenceUtils(context.getApplicationContext(),ty);
        }
